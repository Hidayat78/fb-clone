      ...
      <>
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarInfoItem">
            ...
            <span className="rightbarInfoValue">Okhla</span>
          </div>
          <div className="rightbarInfoItem">
        ...
        <div className="rightbarFollowings">
          <div className="rightbarFollowing">
            ...
            />
            <span className="rightbarFollowingName">Jami</span>
          </div>
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Dilkash</span>
          </div>
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Sarfraz</span>
          </div>
          <div className="rightbarFollowing">
            <img
